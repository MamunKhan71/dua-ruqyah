                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div className="font-inter">
                                        <label htmlFor="my_modal_6" className="hover:cursor-pointer"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <path d="M4.99973 5C4.99973 4.46956 5.21044 3.96086 5.58551 3.58579C5.96058 3.21071 6.46929 3 6.99972 3H16.9997C17.5301 3 18.0388 3.21071 18.4139 3.58579C18.789 3.96086 18.9997 4.46956 18.9997 5V21L11.9997 17.5L4.99973 21V5Z" stroke="#868686" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg></label>
